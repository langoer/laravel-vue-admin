...
class Form extends Component
{
    ...
    protected function prepareInsert($inserts)
    {
        ...
        $columns = \Schema::connection(config('admin.database.connection'))->getColumnListing($this->model()->getTable());
                ...
                case $relation instanceof Relations\MorphMany:
                    ...
                    foreach ($prepared[$name] as $related) {
                        ...
                        foreach ($related as $key => $value) {
                            if (\Schema::connection(config('admin.database.connection'))->hasColumn($instance->getTable(), $key)) {
